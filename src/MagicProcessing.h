...
namespace MTG {
    inline constexpr const size_t AlphaSize = 60;
    ...
    inline size_t NormalizedSetSize = 140;
    ...
    DataVec processData(const nlohmann::json &allSets, bool oracle, char color, bool normalizeSizes);
